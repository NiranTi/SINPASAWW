...
$servicesPath = $basePath . '/app/Services/Denah';
...
file_put_contents($servicesPath . '/RoutingService.php', $routingServiceCode);
echo "RoutingService.php created successfully\n";
echo "DenahService.php will be created in the next step\n";
echo "Directory structure: app/Services/Denah is ready\n";
?>
